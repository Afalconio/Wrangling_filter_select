...
```{r}
movies %>%
  filter(str_detect(title, "Kill Bill")) %>%
  select(title,year,rating) %>%
  arrange(desc(rating))
```

Yes, my favorite movie was in the data set with the different commands such as 'arrange()' and 'filter()' to specify movies into certain categories such as the highest grossing or the highest rated for example.
